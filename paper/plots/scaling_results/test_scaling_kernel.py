...
def main() -> None:
    ...
    for dataset_fname, dataset_path, experiment_path in zip(dataset_fnames, dataset_paths, experiment_paths):
    ...
    df = pd.DataFrame({"dataset": datasets, "model": clfs, "scaling": scaling, "score": accs})
